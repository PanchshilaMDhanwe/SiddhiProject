...
public class LeadDetails_Functions extends AbstractPage {
	...
	@FindBy(xpath = "//*[text()='Comments']/following::input[1]")
	...
	@FindBy(xpath = "//div[@class='dedupeBox MuiBox-root css-0']")
	private ExtendedWebElement Dedupe_PopupText;
	...
	public void Offer(HashMap<String, String> args) throws Exception {
		...
		try {
			...
			String OfferName = driver.findElement(By.xpath("(//*[text()='Campaign Offer'])[1]//following::p[1]"))
					.getText();
			actualResult += " Offer Name - " + OfferName + " | ";
			LOGGER.info(" Offer Name - " + OfferName);
			String ProductName = driver.findElement(By.xpath("(//*[text()='Campaign Offer'])[1]//following::p[2]"))
					.getText();
	...
	/*
	 * public void OfferProducts(HashMap<String, String> args,int i) throws
	 * Exception {
	 * 
	 * String actualResult = args.get("ActualResult");
	 * 
	 * if (i == 1) { Wealth_ViewMore.scrollTo(); Wealth_ViewMore.click();
	 * Wealth_CampaignOffer.scrollTo(); actualResult += +
	 * CU.assertEquals("Campaign Offer", Wealth_CampaignOffer.getText(), args);
	 * CU.takeScreenshot(args, driver, "Wealth Campaigns Offers Available Page");
	 * 
	 * } if (i == 2) { Savings_ViewMore.scrollTo(); Savings_ViewMore.click();
	 * Savings_CampaignOffer.scrollTo(); actualResult += +
	 ...
	 * 
	 * } if (i == 3) { Health_ViewMore.scrollTo(); Health_ViewMore.click();
	 * Health_CampaignOffer.scrollTo(); actualResult += +
	 ...
	 * 
	 * } if (i == 4) { Retirement_ViewMore.scrollTo(); Retirement_ViewMore.click();
	 * Retirement_CampaignOffer.scrollTo(); actualResult += +
	 * CU.assertEquals("Campaign Offer", Retirement_CampaignOffer.getText(), args);
	 * CU.takeScreenshot(args, driver,
	 * "Retirement Campaigns Offers Available Page");
	 * 
	 * } } public void Offer(HashMap<String, String> args) throws Exception {
	 * 
	 * String actualResult = args.get("ActualResult"); try {
	 * 
	 * OfferNdRecommHeading.isVisible(); actualResult += +
	 * CU.assertEquals("Offers & Recommendations", OfferNdRecommHeading.getText(),
	 * args); CU.takeScreenshot(args, driver, "Offers And Recommendation Page");
	 * 
	 * OfferBtn.click(); CU.takeScreenshot(args, driver, "Offers Available Page");
	 * actualResult += + CU.assertEquals(Offer_HeadDate.getText(),
	 * Offer_HeadDate.getText(), args);
	 * 
	 * if (Offer_DotsIcon.isPresent()) { actualResult +=
	 * "Dot Icon button is present"; } else { throw new
	 * Exception("Dot Icon Button not present | "); }
	 * 
	 * actualResult += + CU.assertEquals("Offers Available",
	 * Offer_InnerHeader1.getText(), args); Offer_InnerHeader1.scrollTo(); for (int
	 * i = 1; i <= 4; i++) {
	 * 
	 * OfferProducts(args,i);
	 * 
	 * String OfferName = driver
	 * .findElement(By.xpath("(//*[text()='Campaign Offer'])[" + i +
	 * "]//following::p[1]")).getText(); actualResult += i + " Offer Name - " +
	 * OfferName + " | ";
	 * 
	 * String ProductName = driver
	 * .findElement(By.xpath("(//*[text()='Campaign Offer'])[" + i +
	 * "]//following::p[2]")).getText(); actualResult += i + " Product Name - " +
	 * ProductName + " | ";
	 * 
	 ...
	 * " | "; actualResult += i + " offers Valid date - " +
	 * ValidDate.get(i).getText() + " | ";
	 * 
	 * CopyIcon.get(i).click(); actualResult += +
	 * CU.assertEquals("Campaign Offer details copied to clipboard",
	 * CopyIconMsg.getText(), args); CU.takeScreenshot(args, driver,
	 * "Offers copy icon Page " + i + "");
	 * 
	 * clockIcon.get(i).click(); CU.takeScreenshot(args, driver,
	 * "Offers History Page " + i + ""); actualResult += i +
	 * " click on Clock Icon btn | "; HistoryBackBtn.click();
	 * CU.takeScreenshot(args, driver, "Offers History back Page " + i + "");
	 * actualResult += i + " click on Back btn and back to offers page| ";
	 * 
	 * OfferProducts(args,i);
	 * 
	 * ShareIcon.get(i).isClickable(); CU.takeScreenshot(args, driver,
	 * "Offers Share Icon Page " + i + ""); actualResult += i +
	 * " click on Share icon btn ";
	 * 
	 * ViewLess.click(); CU.takeScreenshot(args, driver, "Offers View Less Page " +
	 * i + ""); actualResult += i + " click on View less btn | "; }
	 * 
	 * if (!args.get("OfferProductName").equalsIgnoreCase("")) {
	 * 
	 * switch (args.get("OfferProductName")) { case "Wealth":
	 * Select_WealthProduct.scrollTo(); Select_WealthProduct.click();
	 * CU.takeScreenshot(args, driver, "Select Wealth Product Page"); actualResult
	 * += "Select Wealth Product | "; break;
	 * 
	 * case "Savings": Select_SavingsProduct.scrollTo();
	 * Select_SavingsProduct.click(); CU.takeScreenshot(args, driver,
	 * "Select Savings Product Page"); actualResult += "Select Savings Product | ";
	 * break; case "Health": Select_HealthProduct.scrollTo();
	 * Select_HealthProduct.click(); CU.takeScreenshot(args, driver,
	 * "Select Health Product Page"); actualResult += "Select Health Product | ";
	 * break;
	 * 
	 * case "Retirement": Select_RetirementProduct.scrollTo();
	 * Select_RetirementProduct.click(); CU.takeScreenshot(args, driver,
	 * "Select Retirement Product Page"); actualResult +=
	 * "Select Retirement Product | "; break; }
	 * 
	 * StartJourney.scrollTo(); StartJourney.click(); CU.takeScreenshot(args,
	 * driver, "Start journey Page"); actualResult +=
	 * "Start journey button is enable | "; }
	 * 
	 * Offer_HeadDate.scrollTo(); Offer_HeadDate.click(); CU.takeScreenshot(args,
	 * driver, "Back to lead Details Page"); actualResult +=
	 * "Back to lead details page | ";
	 * 
	 * args.put("ActualResult", actualResult); } catch (Exception e) {
	 * e.getStackTrace(); System.out.println(e.getMessage()); actualResult +=
	 * e.getMessage(); args.put("ActualResult", actualResult);
	 * CU.takeScreenshot(args, driver, "Error Page");
	 * 
	 * if (args.get("Test Case Type").equalsIgnoreCase("Negative")) {
	 * args.put("status", "Pass"); } else { args.put("status", "Fail"); } } }
	 */
	...
	public void StartJourney(HashMap<String, String> args) throws Exception {
		...
		try {
			...
			StartJourney.click();
			actualResult += CU.assertEquals("Do you want to provide the referral?", Popup_Text.getText(), args);
			...
			if (args.get("Response").equalsIgnoreCase("Yes")) {
				...
				if (args.get("Dedupe_Flag").equalsIgnoreCase("Yes")) {
					AddLeadDetails(args);
					actualResult = args.get("ActualResult");
					Proceed.click();
				...
				actualResult += "Select Response Yes Add new details as FullName - " + Fullname + " And Phone Number - "
						+ mobileNumber + " | ";
				LOGGER.info("Select Response Yes Add new details as FullName - " + Fullname + " And Phone Number - "
						+ mobileNumber);
				Proceed.click();
				CU.takeScreenshot(args, driver, "Popup Page");
				actualResult += CU.assertEquals("Lead has been added successfully!", Successfull_Popup_text.getText(),
						args);
				...
				actualResult += "new Lead Status as " + LeadStatus1.getText() + " and " + LeadStatus2.getText() + " | ";
				...
				actualResult += "old Lead Status as " + LeadStatus1.getText() + " and " + LeadStatus2.getText() + " | ";
		...
		try {
			...
			if (!args.get("SearchRefferal_Lead").equalsIgnoreCase("")) {
				...
				if (!RefferalLead.isPresent()) {
					LOGGER.info("Referral Lead is not present");
				} else {
					CU.takeScreenshot(args, driver, "Search Referral Sources Page");
					RefferalLead.click();

					actualResult += CU.assertEquals("Referral for the lead has been added successfully!",
							Refferal_successfulText.getText(), args);
					...
					actualResult += " After referral flow is done status change as - " + LeadStatus2.getText() + " | ";
			...
			if (args.get("UnclickSources").equalsIgnoreCase("Yes")) {
				for (int i = 1; i <= 6; i++) {
					...
					if (!args.get("Sources" + i + "").equalsIgnoreCase("")) {
						...
						LOGGER.info("Unclick source = " + args.get("Sources" + i + ""));
					}
				}
	...
	public void AddLeadDetails(HashMap<String, String> args) throws Exception {

		String actualResult = args.get("ActualResult");
		String Fullname = CommonWebUtilities.RandomString_CapitalLetters(1)
				+ CommonWebUtilities.RandomString_SmallLetters(4);
		Lead_FullName.type(Fullname);
		Lead_Phone.type(args.get("MobileNumber"));
		CU.takeScreenshot(args, driver, "Add new lead details Page");
		actualResult += "Add new details as FullName - " + Fullname + " And Phone Number - " + args.get("MobileNumber")
				+ " | ";
		args.put("ActualResult", actualResult);

	}

	public void Dedupe_Popup(HashMap<String, String> args) throws Exception {

		String actualResult = args.get("ActualResult");
		actualResult += "Popup Msg - " + Dedupe_PopupText.getText() + " | ";
		CU.takeScreenshot(args, driver, "Dedupe Popup Page");
		Continue_Btn.click();
		actualResult += " Click on continue | ";

		waitUntil(ExpectedConditions.elementToBeClickable(LeadDetailsBtn.getElement()), EXPLICIT_TIMEOUT);
		ViewMore.click();
		CU.takeScreenshot(args, driver, "Lead Details Page");

		actualResult += "Lead Name - " + LeadName.getText() + " , Mobile Number - " + LeadMobileNumber.getText() + " |";
		actualResult += "Lead Status as " + LeadStatus1.getText() + " and " + LeadStatus2.getText() + " | ";
		LOGGER.info("Lead Status As - " + LeadStatus1.getText() + " And " + LeadStatus2.getText());
		KillBtn.scrollTo();
		CU.takeScreenshot(args, driver, "Lead Details Page");

		actualResult += CU.assertEquals("Reminder", Reminder.getText(), args);
		actualResult += CU.assertEquals("Meet", Meet.getText(), args);
		actualResult += CU.assertEquals("Not Contactable", NonContactable.getText(), args);
		actualResult += CU.assertEquals("Kill", KillBtn.getText(), args);
	...
	public void Killflow(HashMap<String, String> args) throws Exception {
		...
		try {
			...
			actualResult += CU.assertEquals("Customer is not interested", CustomerNotInterested.getText(), args);
			actualResult += CU.assertEquals("Others", Others.getText(), args);
			...
			if (args.get("Response").equalsIgnoreCase("Later")) {
				...
				Proceed.click();
				CU.takeScreenshot(args, driver, "KILL After Proceed Page");
				actualResult += CU.assertEquals("Lead has been killed successfully !", KillPopup_text.getText(), args);
				LOGGER.info("Proceed Kill flow");
				closeBtn.click();
				CU.takeScreenshot(args, driver, "Done Kill flow Page");
				LeadDetailsBtn.scrollTo();
